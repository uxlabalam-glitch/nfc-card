...
export default function EditCardPage() {
  ...
  /* =========================================================
     SAVE
     URL BO‘SH BO‘LSA HAM LINK SAQLANADI
  ========================================================= */
    ...
    try {
      ...
      for (let i = 0; i < links.length; i++) {
        ...
        const payload = {
          ...
          // MUHIM:
          // URL bo‘sh bo‘lsa ham bazaga yoziladi.
          url: link.url?.trim() || "",
...
const saveButtonStyle = {
  ...
  boxShadow:
    "0 10px 28px rgba(57,119,239,.24)",
